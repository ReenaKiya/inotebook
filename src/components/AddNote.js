...
const AddNote = (props) => {
  ...
  const handleClick = (e) => {
    ...
    props.showAlert("Addnote Successfully", "success")
  }
    ...
    <div className="container my-3">
      ...
      <form className=" my-3">
        ...
        <div className="mb-3">
          ...
          <input type="text" className="form-control" id="discription" value={note.discription} name="discription" onChange={onChange} minLength={5} required />
        </div>
        <div className="mb-3">
